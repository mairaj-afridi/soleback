...
const Setting = () => {
  ...
  return <section className='rounded-md shadow-md   min-h-[521px] h-full w-full gap-4 sm:gap-8 bg-white-main flex flex-col items-center justify-start '>
    ...
    {/* switch div */}
    <div className="bg-white-main shadow-lg gap-6    w-full  h-[65px] flex items-center justify-start   ">

      <AiOutlineLaptop className='text-[17px] ml-5 sm:text-[24px] flex-shrink-0' />
